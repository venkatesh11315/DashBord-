    ...
    return (
        <div className='container-fluid'>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Dashbord</h1>
                ...
                <div className='col-7'>
                    <div className='card'>
                        <div className='card-header'>
                            <h5> Earing overview</h5>
                        </div>
                        <div className='card-body  ' >
                            <picture className="img-fulid">
                           
                            <LineChartExample className="img-fulid"/>
           ...
           {/* !-- Content Column --> */}
                        <div className="col-lg-6 mb-6 mt-4">
