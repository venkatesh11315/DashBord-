                ...
                <div className='col-6'>
                    ...
                    <div class="card-header py-3">
                        ...
                        <div className='card-body'>
                            ...
                            <a href="#" className="btn btn-primary btn-circle btn-sm m-1">
                                <i className="fab fa-facebook-f"></i>
                            </a>
                            <a href="#" className="btn btn-success btn-circle btn-sm m-1">
                                <i className="fas fa-check"></i>
                            </a>
                            <a href="#" className="btn btn-info btn-circle btn-sm m-1">
                                <i className="fas fa-info-circle"></i>
                            </a>
                            <a href="#" className="btn btn-warning btn-circle btn-sm m-1">
                            ...
                            <a href="#" className="btn btn-primary btn-circle btn-lg m-1">
                                <i className="fab fa-facebook-f"></i>
                            </a>
                            <a href="#" className="btn btn-success btn-circle btn-lg m-1">
                                <i className="fas fa-check"></i>
                            </a>
                            <a href="#" className="btn btn-info btn-circle btn-lg m-1">
                                <i className="fas fa-info-circle"></i>
                            </a>
                            <a href="#" className="btn btn-warning btn-circle btn-lg m-1">
                                <i className="fas fa-exclamation-triangle"></i>
                            </a>
